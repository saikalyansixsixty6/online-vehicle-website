  ...
  return (
    <div className="car-container w-64">
      <Link to={`/car_details/${id}`} state={{ vehicle }}>
        <div className="max-w-xs rounded-lg overflow-hidden shadow-lg car-box h-full flex flex-col">
          <div className="car-img flex-1">
            <img src={imageUrl} alt="car" className="w-full h-full object-cover" />
          </div>
